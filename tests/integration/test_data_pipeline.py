...
class TestDataIngestionPipeline:
    ...
    async def test_fetch_and_store_ohlcv(
        self, db_session, mock_ccxt_client, sample_ohlcv_data, test_settings
    ):
    ...
    async def test_fetch_with_retry_on_failure(self, db_session, mock_ccxt_client, test_settings):
...
class TestDataTransformationPipeline:
    ...
    async def test_calculate_indicators_on_raw_data(self, db_session, sample_ohlcv_dataframe):
    ...
    async def test_aggregate_multiple_timeframes(self, db_session, sample_ohlcv_dataframe):
...
class TestCacheIntegration:
    ...
    async def test_cache_ohlcv_data(self, mock_redis, mock_ccxt_client, sample_ohlcv_data):
    ...
    async def test_cache_miss_fetches_from_exchange(
        self, mock_redis, mock_ccxt_client, sample_ohlcv_data
    ):
    ...
    async def test_cache_hit_skips_exchange(self, mock_redis, mock_ccxt_client, sample_ohlcv_data):
...
class TestHistoricalDataBackfill:
    ...
    async def test_backfill_missing_date_range(self, db_session, mock_ccxt_client, test_settings):
